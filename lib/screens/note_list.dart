...
import 'package:note_it/db_helper/db_helper.dart';
import 'package:note_it/modal_class/notes.dart';
import 'package:note_it/screens/search_note.dart';
import 'package:note_it/utils/widgets.dart';
  ...
  Widget build(BuildContext context) {
        ...
        leading: noteList.length == 0
            ...
            : IconButton(
                icon: Icon(
                  ...
                  color: Color.fromRGBO(23, 208, 254, 1),
                ),
                onPressed: () {
                  setState(() {
    ...
    return Scaffold(
          ...
          ? Container(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    _buildImage('find.gif'),
                    Padding(
                      padding: const EdgeInsets.all(25.0),
                      child: Text('Click on add button to add a new note!',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'Add Note',
        shape: CircleBorder(side: BorderSide(color: Color.fromRGBO(23, 208, 254, 1), width: 0.0)),
        child: Icon(Icons.add, color: Colors.white,size: 30,),
        backgroundColor: Color.fromRGBO(23, 208, 254, 1),
      ),
    );
  }
